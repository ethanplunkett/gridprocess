context("Conversion between different spatial formats")
...
test_that("Conversion from SpatialPointsDataFrame to grid is consistent with past values", {
  ...
  expect_known_hash(g, "4d490ddc92")
...
test_that("Grid to raster conversion works", {
  expect_silent(r <- raster(g))
  expect_that(r, is_a("RasterLayer"))
  expect_known_hash(r, "52ddac6306")
