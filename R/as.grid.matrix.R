asgrid.matrix <- function(x, xll, yll, cellsize, ...){
  # asgrid.matrix  Ethan Plunkett   March 13, 2012
  ...
  #  Note  xll, yll, and cellsize are all in the projection of your choice.
  # grids are ignorant of projections.
...
# Example call
# mat <- matrix(1:12, 3, 4)
# g <- asgrid(mat, xll=0, yll=0, cellsize=30)
